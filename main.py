    ...
    def button_edit_stuff(self, button:str, button_type:str):
        ...
        def toggle_thumbstick():
            if self.stick_type.get() == "Keyboard":
                ...
                up_button = tk.Button(self.edit_profile_window, text="KB.w", command=lambda: change_movement_buttons(0, self.new_profile["stick"][0], up_button))
                ...
                self.thumbstick_wasd_buttons.append(label)
                left_button = tk.Button(self.edit_profile_window, text="KB.a", command=lambda: change_movement_buttons(1, self.new_profile["stick"][1], left_button))
                ...
                self.thumbstick_wasd_buttons.append(label)
                down_button = tk.Button(self.edit_profile_window, text="KB.s", command=lambda: change_movement_buttons(2, self.new_profile["stick"][2], down_button))
                ...
                self.thumbstick_wasd_buttons.append(label)
                right_button = tk.Button(self.edit_profile_window, text="KB.d", command=lambda: change_movement_buttons(3, self.new_profile["stick"][3], right_button))
